...
<div class="card">
  <div class="card-header">
    <h4>Карзга бериу болими</h4>
  </div>
  <div class="card-body">
    <form action="{{ Route('debt-tovar') }}" method="POST">
      @csrf
...
<select name="tolem" id="" class="form-control" disabled style="width: 100px">
<option value="Qarzga">Карз</option>
</select>
    </div>
  </div>
  <div class="col">
    div class="form-group">
    <label for="debtor">Ф.И.О</label>
    <input type="text" name="debtor" id="debtor">
    <label for="phone1">Телефоны</label>
...
<label for=""></label>
  ...
  @endif" tabindex="-1">
    ...
    </div><div class="swal-title" style="">Товар карзга берилди!</div><div class="swal-text" style=""></div><div class="swal-footer"><div class="swal-button-container">
